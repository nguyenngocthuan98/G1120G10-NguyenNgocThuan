...
<div class="container col-5 border" style="padding: 10px">
    <h1>WELCOME HOME</h1>
    <br/>
    <h4>Hi <i>${user.name}</i></h4>
    <label for="myInput">Your password:</label>
    <input type="password" value="${user.password}" id="myInput" disabled/>
    <input type="checkbox" onclick="myFunction()"/> Show Password <br>
    <label for="myInput">Your email:</label>
    <input type="text" value="${user.email}" disabled/><br>
    <label for="myInput">Your age:</label>
    <input type="text" value="${user.age}" disabled/><br>
