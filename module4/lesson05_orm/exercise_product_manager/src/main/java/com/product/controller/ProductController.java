...
public class ProductController {
    ...
    public String createProduct(Product product, RedirectAttributes redirect) {
        ...
        redirect.addFlashAttribute("messageCreate", "Created product " + product.getName() + " success!");
        return "redirect:/";
    }
    ...
    public String updateProduct(Product product, RedirectAttributes redirect) {
        productService.create(product);
        redirect.addFlashAttribute("messageUpdate", "Updated product " + product.getName() + " success!");
        return "redirect:/";
    }
